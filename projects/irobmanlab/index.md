...
<div class="col-sm mt-3 mt-md-0">
  <img src="assets/img/st-rrt.png" loading="eager" class="img-fluid rounded z-depth-1" alt="ST-RRT">
...
<img src="assets/img/STRRT CODE.png" loading="eager" class="img-fluid rounded z-depth-1" alt="STRRT CODE">
...
<img src="assets/img/transformation.png" loading="eager" class="img-fluid rounded z-depth-1" alt="transformation">
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <video class="img-fluid rounded z-depth-1" controls autoplay muted playsinline>
      <source src="assets/video/collaboration_1.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
    <p class="mt-2 small text-center">Task1: Collaborative grasp of a box using KOMO</p>
  </div>
  <div class="col-sm mt-3 mt-md-0">
    <video class="img-fluid rounded z-depth-1" controls playsinline>
      <source src="assets/video/collaboration_2.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
    <p class="mt-2 small text-center">Task2: Collaborative grasp of two boxes using KOMO</p>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <video class="img-fluid rounded z-depth-1" controls autoplay muted playsinline>
      <source src="assets/video/stacking_co_3.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
    <p class="mt-2 small text-center">Task3: Collaborative stacking three boxes using KOMO</p>
  </div>
  <div class="col-sm mt-3 mt-md-0">
    <video class="img-fluid rounded z-depth-1" controls playsinline>
      <source src="assets/video/cooperation_4.mp4" type="video/mp4">
      Your browser does not support the video tag.
    </video>
    <p class="mt-2 small text-center">Task4: Collaborative grasp of a box while avoiding obstacles using KOMO</p>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm mt-3 mt-md-0">
    <video class="img-fluid rounded z-depth-1" controls autoplay muted playsinline>
      <source src="assets/video/collaboration_st_rrt.mp4" type="video/mp4">
    </video>
